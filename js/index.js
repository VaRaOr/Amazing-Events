...
/* function displayCardEventos(data) {
    ...
    <div class="col pb-3">
        <div class="card h-100">
            <img src="${data.image} " class="card-img-top xd" alt=" ${data.name} " />
            <div class="card-body">
                <h5 class="card-title"> ${data.name} </h5>
                <p class="card-text">Description: ${data.description} </p>
            </div>
            <div class="card-footer d-flex align-items-center justify-content-between">
                <small class="text"> Price: ${data.price}</small>
...
/*
    <div class="col pb-3">
        <div class="card h-100">
            <img src="/assets/fiestaDeDisfraces1.jpg" class="card-img-top xd" alt="costumeParty" />
            <div class="card-body">
                <h5 class="card-title">Costume Party</h5>
                <p class="card-text">Description:</p>
            </div>
            <div class="card-footer d-flex align-items-center justify-content-between">
                <small class="text"> Price: $200</small>
                <a href="/html/details.html" class="btn boton-rosita btn-sm">Ver mas</a>
            </div>
        </div>
    </div>
 */
