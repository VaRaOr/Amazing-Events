//data.currentDate   // voy a acceder a la fecha de base
//data.events.length //voy a acceder a los eventos en el array
...
function categoriasXD(array) {
    ...
    var todasLasCategorias = array.map(eventos => eventos.category) //Recorro el array de eventos y separo de este la propiedad categorias
...
/* var contenCartas = document.querySelector(".cartinias");
var arrayeventos = data.events;

function cartitasxd(){
    var padre = document.querySelector(".cartinias");
...
//ANCHOR CATEGORIAS 
var categorias = arrayeventos.map(e => e.category).filter((element, position, arrayeventos) =>{
    return position === arrayeventos.indexOf(element);
})
console.log(categorias)
var contenCategorias = document.querySelector(".Category")
